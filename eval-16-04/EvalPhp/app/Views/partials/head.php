...
<head>
    ...
    <link rel="stylesheet" href="public/css/style.css"><!-- '/' a supprimé pour afficher -->
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light text-white pb-3">
    <div class="container-fluid">
        <a class="navbar-brand mt-2 mt-lg-0 text-white" href="/eval-16-04/EvalPhp">
            <img src="public/img/Icon.png" alt="Logo" class="imgLogo"><!-- '/' a supprimé pour afficher img -->
            Forum
        </a>
